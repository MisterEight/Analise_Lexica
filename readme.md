...
Codigo-fonte do trabalho na pasta [`Analisador Sintatico - MicroPascal/`](Analisador%20Sintatico%20-%20MicroPascal/).
...
A partir da raiz do repositorio, entre na pasta do projeto:

```
cd "Analisador Sintatico - MicroPascal"
```

Compilando direto com o gcc:
...
Em seguida, rode um dos testes:

```
sintatico testes/correto1.pas
```

(Em Linux / macOS use `./sintatico testes/correto1.pas`.)
...
Todos os arquivos de teste estao em
[`Analisador Sintatico - MicroPascal/testes/`](Analisador%20Sintatico%20-%20MicroPascal/testes/).
